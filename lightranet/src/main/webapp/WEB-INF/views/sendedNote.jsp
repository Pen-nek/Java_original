						...
						<tbody>
							<c:forEach items="${list}" var="note">
								<tr>
									...
									<td><a href="#"
										onclick="window.open('/readSendNote?n_id=<c:out value="${note.n_id} "/>','read','width=500 height=600, left=400, top=300');return false">
											<c:out value="${note.n_content }" />
									</a></td>
